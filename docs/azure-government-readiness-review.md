...
|---|---|---|---|
| 1. Advanced Semantic Modeling | Star schema, relationships, role-playing dimensions, bridge tables, field parameters where tenant parity is confirmed | Composite models, DirectQuery source behavior, calculation groups, hybrid tables, large semantic models | Import-mode model, duplicated role-playing dimensions, standard DAX measures, conceptual discussion for tenant-dependent features |
| 2. Advanced DAX | Core DAX, context transition, time intelligence, ranking, dynamic titles, measure switching | DAX Studio and external tooling | Use Desktop visuals and Performance Analyzer; keep DAX Studio optional |
...
| 4. Report Design and UX | Drillthrough, tooltips, bookmarks, buttons, navigation, conditional formatting, mobile layout, accessibility review | Personalized visuals, AI visuals, mobile app policy | Native visuals and non-AI interaction patterns |
