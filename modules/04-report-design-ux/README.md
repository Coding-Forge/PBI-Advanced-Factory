...
- Design reports for executive, analyst, and operational user personas.
- Use drillthrough to move from summary analysis to transaction detail.
...
- Identify Azure Government considerations for personalized visuals and AI visuals.

## Feature availability

| Feature | Status | Delivery note |
|---|---|---|
| Drillthrough | Gov-ready | Core report authoring feature. |
...
| AI visuals | Verify for Gov / Commercial-focused | Validate feature availability before using in Gov labs. |
